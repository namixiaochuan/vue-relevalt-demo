...
import left from "@/page/top/components/left.vue";
import middle from "@/page/top/components/middle.vue";
import right from "@/page/top/components/right.vue";
import {
...
.top-body {
  background-image: linear-gradient(90deg, $bcBlue, $tintBlue);
  height: 50px;
